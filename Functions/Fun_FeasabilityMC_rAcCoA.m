function [is_mc_feasible,uc,xc]=Fun_FeasabilityMC_rAcCoA(pHc,beta,x_c_H2,x_ub,index)
clc;
...
%% Parameters
T=25+273.15;                                        % K
pH=[7;pHc;8.0;7.5;7];                               % -             1->e, 2->c, 3->f, 4->single compartment,  5->reference for flux dir correction        
pH_p=2;                                             % -
