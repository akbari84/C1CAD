function [assim_rate,uc1,xc1,exitflag]=Fun_AssimRateSC_rGly(xc_0,pHc,beta,x_c_H2,x_ub,index)
clc;
...
[ln_x,obj,exitflag,output]=fmincon(@(ln_x)Fun_Obj(ln_x,S,Keq1,kapp1,varth,rxn,[jc;jf;je_v],n_rxn1,n_met),sol.x,Aineq,bineq,Aeq,beq,lb1,ub1,[],options);
if exitflag>=-1
    xc1=exp(ln_x);
